...
{
    //note: partial class allow us to break class definitions across multiple files.
    // good for auto-generated code, like ef-core, and us to extend definitions.
    public partial class FlyingDutchmanAirlinesContext : DbContext
    {
        ...
        //DbSet types contain tables & their contents
        public virtual DbSet<Airport> Airports { get; set; }
        public virtual DbSet<Booking> Bookings { get; set; }
        public virtual DbSet<Customer> Customers { get; set; }
        public virtual DbSet<Flight> Flights { get; set; }

        //on configuring is called on launch automatically on the dbcontext.
        //it uses dependency injection to provide the DbContextOptionsBuiulder
        // MAIN PURPOSE: configure settings related to database connection (ex: connection string).
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                String connectionString = 
                    //note: stored connection string as an enviroment variable to avoid hard coded connection strings.
                    //note: "??" is null-coalescing operator. if not null, returns left value. else, right value.
                    Environment.GetEnvironmentVariable("FlyingDutchmanAirlines_Database_Connection_String") ?? String.Empty; //grab connection string from system env. var.
